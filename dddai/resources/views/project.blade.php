	                      ...
	                      <ul class="clearfix td_all">
	                        ...
	                        <li class="fl td5">
	                            ...
	                            <p><span class="airal fs_24 fc_orange">
	                                   {{($project->money - $project->receive) / 100}}
	                            </span>元</p>
	                        </li>
                	...
                	<div class="td_all2">
                        ...
                        <table width="100%" class="fc_6">
                            ...
                            <tr>
                                ...
                                <td style="padding-right:0;width:220px;">
                                <input style="width:140px;" class="fc_orange airal fs_18" name="money" value=" {{($project->money - $project->receive) / 100}}">元
                                </td>
                            </tr>                          
                        </tbody>
                        </table>

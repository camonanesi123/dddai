...
{!! csrf_field() !!}
 <div class="application">
        ...
        <div class="delCon">
            ...
            <div class="iptBox">
                <span>真实年龄</span>
                <select class="ageBox" id="age" name="age" placeholder="请输入真实年龄" maxlength="3" type="text">
                    <option selected="selected" value="0">请选择年龄段</option>
                    <option value="15">23岁以下</option>
                    <option value="40">23岁-55岁</option>
                    <option value="80">岁以上55岁</option>
                </select>  
                @if($errors->has('age'))
            ...
            <div class="iptBox">
                ...
                <i><button type="button" class="get-code" id="dtmbtn" name="dtmbtn" value="">获取验证码</button></i>
            </div>
...
<script type="text/javascript">
     $('#applyForm').submit(function(){
        ...
        pattern=/^[1-9]\d*$/    //\d  匹配一个数字字符。等价于 [0-9]。
        //\D   匹配一个非数字字符。等价于 [^0-9]。  
 
       if(!pattern.test($('#loanAmount').val())){
            alert('金额必须整数');
            return false;
       }
        pattern=/^1[3578]\d{9}$/

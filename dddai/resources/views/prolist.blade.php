                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                   <td class="f">{{$project->pid}}</td>
                                   <td>{{date('Y/m/d H:i',$project->pubtime)}}</td> 
                                   <td class="tr"><span>{{$project->name}}</span></td> 
                                   <td class="tr">{{$project->money/100}}</td> 
                                   <td class="tr">{{$project->mobile}}</td>
                                   <td class="">
                                   @if($project->status==0)
                                   待审核
                                   ...
                                   <td class="l"><a href="{{url('check',$project->pid)}}">审核</a></td>
                                </tr>
                               @empty

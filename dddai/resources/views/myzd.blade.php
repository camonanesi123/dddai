    ...
    <div class="clearfix main_wrapper">
    	<div class="container">
            <div class="accountCenter">
                ...
                <span  style="float: right;margin-right: 20px">单位：元</span>
            </div>
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                @foreach($hks as $hk)                                
                                <tr>
                                   <td class="f">{{$hk->hid}}</td>
                                   <td class="f">{{$hk->title}}</td>
                                   <td class="f">{{$hk->amount/100}}</td>
                                   <td class="f">{{$hk->paydate}}</td>
                                   <td class="f">{{$hk->status}}</td>                                 
                                   <td class="f">
                                        @if($hk->status==0)
                                        <a href="">立即还款</a>
                                        @else 

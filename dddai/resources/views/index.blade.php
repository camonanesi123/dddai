                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            <li class="w1">
                                ...
                                <p class="fc_orange airal"><em class="fs_28">{{$project->rate}}</em>
                                    <em class="fs_18">%</em>                       
                                </p>
                            </li>
                            <li class="w2">
                                <p class="fc_9 mb_5">期限</p>
                                <p class="fc_6"><em class="fs_18">{{$project->hrange}}</em>个月</p>
                            </li>
                            <li class="w3">
                                <p class="fc_9 mb_5">已投资金额 </p>
                                <p class="fc_6 airal fs_18">{{$project->receive/100}}元</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{$project->receive/$project->money*100}}">{{sprintf('%.2f',$project->receive/$project->money*100)}}%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="{{url('project',[$project->pid])}}">立即投标</a>
                            </li>
                        </ul>
                    </div>
                    @endforeach
